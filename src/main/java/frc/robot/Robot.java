...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("Motor Position", MotorTesting.m_Motor.getSelectedSensorPosition());
    SmartDashboard.putNumber("Speaker ID: ", Constants.VisionConstants.SpeakerID);
    SmartDashboard.putNumber("Amp ID: ", Constants.VisionConstants.AmpID);
  }
