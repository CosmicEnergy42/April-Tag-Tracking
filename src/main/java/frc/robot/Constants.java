...
public final class Constants {
  ...
  public static class MotorConstants{
    ...
    public static MotorConfigs motorConfigs = new MotorConfigs();
  ...
  public static final class DriveConstants {
    public static final int kLeftPrimaryMotorPort = 3;
    public static final int kLeftSecondaryMotorPort = 4;
    public static final int kRightPrimaryMotorPort = 1;
    public static final int kRightSecondaryMotorPort = 2;
    ...
    public static final double kTrackwidthMeters = 0.61595;
